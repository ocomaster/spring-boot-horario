...
public class AppController {
	...
	public String cerrado(Model model) {
		...
		StringBuilder mensaje = new StringBuilder("Cerrado, por favor visitarnos desde las");
		...
		model.addAttribute("titulo","Estas ingresando por fuera del horario de atencion");
